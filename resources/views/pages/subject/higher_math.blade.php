                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Higher Math Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_higher_math_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'higher_math' AND (`status` = 0 OR `status` = 2)");
                                      $higher_math_count = count($count_higher_math_ques);
                                       @endphp
                                      <h3 class="panel-title">Total Higher Math Pending Question ={{$higher_math_count}} </h3>
                                  </div>
                            <?php                           
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table id="datatable" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                                    @foreach($higher_math_sub as $val)
