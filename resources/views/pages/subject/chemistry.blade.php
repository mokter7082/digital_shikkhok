                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Chemistry Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_chemistry_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'chemistry' AND (`status` = 0 OR `status` = 2)");
                                      $chemistry_count = count($count_chemistry_ques);
                                       @endphp
                                      <h3 class="panel-title">Total Chemistry Pending Question ={{$chemistry_count}} </h3>
                                  </div>
                            <?php                           
