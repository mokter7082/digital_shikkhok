                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">English Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_english_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'english' AND (`status` = 0 OR `status` = 2)");
                                      $english_count = count($count_english_ques);
                                       @endphp
                                      <h3 class="panel-title">Total English Pending Question ={{$english_count}} </h3>
                                  </div>
                                                    ...
                                                    @foreach($english_sub as $val)
                                                      <tr id = "tr-{{$val->id}}">
                                                        ...
                                                        <td>
                                                          ...
                                                          <textarea name="ans" id="ans_{{$val->id}}" rows="3" cols="35" placeholder="Write Answer Here" required></textarea>
