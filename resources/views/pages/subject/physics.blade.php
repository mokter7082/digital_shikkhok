                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Physics Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_physics_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'physics' AND (`status` = 0 OR `status` = 2)");
                                      $physics_count = count($count_physics_ques);
                                       @endphp
                                      <h3 class="panel-title">Total Physics Pending Question ={{$physics_count}} </h3>
                                  </div>
                 <?php                           
