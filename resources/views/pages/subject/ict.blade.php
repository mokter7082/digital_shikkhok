                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">ICT Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_ict_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'ict' AND (`status` = 0 OR `status` = 2)");
                                      $ict_count = count($count_ict_ques);
                                       @endphp
                                      <h3 class="panel-title">Total ICT Pending Question ={{$ict_count}} </h3>
                                  </div>
                          <?php                           
