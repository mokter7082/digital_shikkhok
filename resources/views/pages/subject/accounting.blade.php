                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Accounting Question</h3>
                                  </div>
                    <?php                           
                                                    ...
                                                    @foreach($accounting_sub as $val)
                                                      <tr id = "tr-{{$val->id}}">
                                                        ...
                                                        <td>
                                                          ...
                                                          <button class="btn btn-primary btn-sm" onclick="myFunction({{$val->id}})" type="button">submit</button>
