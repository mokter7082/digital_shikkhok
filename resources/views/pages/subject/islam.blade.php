                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Islam Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_islam_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'islam' AND (`status` = 0 OR `status` = 2)");
                                      $islam_count = count($count_islam_ques);
                                       @endphp
                                      <h3 class="panel-title">Total Islam Pending Question ={{$islam_count}} </h3>
                                  </div>
                              <?php                           
