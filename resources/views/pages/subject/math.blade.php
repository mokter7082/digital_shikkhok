                      ...
                      <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Math Question</h3>
                                  </div>
                                  <div class="panel-heading">
                                    @php
                                      $count_math_ques = DB::select("SELECT * FROM `post_q` WHERE `subject` = 'math' AND (`status` = 0 OR `status` = 2)");
                                      $math_count = count($count_math_ques);
                                       @endphp
                                      <h3 class="panel-title">Total Math Pending Question ={{$math_count}} </h3>
                                  </div>
                            <?php                           
